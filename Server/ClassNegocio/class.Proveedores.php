...
function __construct(){
 ...
 function MapaBase(){
	...
	$this->Map['DSRazonSocial']='T0.pro_razon_social';
	$this->Map['DSDireccion']='T0.pro_direccion';
	$this->Map['DSTelefono']='T0.pro_telefono';
	$this->Map['DSMail']='T0.pro_mail';
